...
Command: java -jar StackoverflowAnalyzer.jar pathToDataset	posTagging 2 1
Output: 
...
Command: java -jar StackoverflowAnalyzer.jar pathToDataset	nBestPOSSequence 2 1 3
Output: 
...
Command: java -jar StackoverflowAnalyzer.jar pathToDataset	nBestPOSTag 2 1 3
Output: 
